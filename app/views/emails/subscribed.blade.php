...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
      <!-- NAME: 1 COLUMN -->
        ...
        <title>Your list is being tracked!</title>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <h1>Your list is being tracked!</h1>

<h3>Thank you for subscribing :)</h3>

<p>Now that you have subscribed to our email, we will send you any updates about the person you have in the list based on your preferences!</p>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <em>Copyright © 2014 vBanStatus</em><br>
<br>
<a class="utilityLink" href="{{{ URL::route('unsub', array( $user->unsub )) }}}">unsubscribe from this list</a>&nbsp;&nbsp;&nbsp; <a class="utilityLink" href="{{{ URL::route('setting') }}}">update subscription preferences</a>&nbsp;
                        </td>
                    </tr>
                </tbody></table>
