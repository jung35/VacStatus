...
<p>Now the final step is to verify your mail and you're in! The list that you made will be tracked!</p>
<p>Please click to verify: <a href="{{{ URL::route('verify', $verify) }}}">{{{ URL::route('verify', $verify) }}}</a> </p>
...
<br>
<a class="utilityLink" href="{{{ URL::route('subscribe') }}}">edit subscription settings</a>
                        </td>
                    </tr>
                </tbody></table>
