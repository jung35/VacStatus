...
class AdminController extends \BaseController {
  ...
  public function indexAction() {
    ...
    if(!Cache::has('admin-profiles')
       || !Cache::has('admin-users')
       || !Cache::has('admin-list-total')) {
    ...
    if(!Cache::has('admin-list-public')
       || !Cache::has('admin-list-friend')
       || !Cache::has('admin-list-private')) {
    ...
    if(!Cache::has('admin-donation')
       || !Cache::has('admin-donation-after')
       || !Cache::has('admin-donation-average')) {
